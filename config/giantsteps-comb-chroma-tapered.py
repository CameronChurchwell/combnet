...
# cache dir containing 22.05kHz features
# from pathlib import Path
# CACHE_DIR = Path('/scr/cameron/combnet/cache-22.05')
...
MODEL_KWARGS = {
    ...
    'comb_kwargs': {
        ...
        'min_freq': 25.96,
        'max_freq': 55.00,
        'comb_fn': 'fractional_comb_fir_multitap_lerp_explicit_triton_fused_tapered'
    },
}
