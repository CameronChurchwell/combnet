...
class _explicit_sinc_triton(torch.autograd.Function):
    """
...
def fractional_comb_fir_multitap_sinc_explicit_triton(x, f0, a, sr):
    if x.dim() == 1: # time
        x = x[None, None]
    ...
    y = _explicit_sinc_triton.apply(x, y, a, l, n_taps)
